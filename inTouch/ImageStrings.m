...
NSString *const mailIconImageName = @"mailIcon.png";
NSString *const manuallyContactedIconImageName = @"manuallyContactedIcon.png";
NSString *const messageIconImageName = @"messageIcon.png";
NSString *const phoneIconImageName = @"phoneIcon.png";
