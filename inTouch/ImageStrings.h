 /*!
 @header ImageStrings.h
 
 @brief Global NSString constants for image names.
...
extern NSString *const backIconImageName;
extern NSString *const mailIconImageName;
extern NSString *const manuallyContactedIconImageName;
extern NSString *const messageIconImageName;
extern NSString *const phoneIconImageName;
